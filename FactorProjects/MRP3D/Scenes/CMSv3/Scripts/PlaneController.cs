...
namespace FactorProjects.MRP3D.Scenes.CMSv3.Scripts
{
    public class PlaneController : MonoBehaviour
    {
        ...
        /// </summary>
        public List<ProcessRecord> ProcessList { get; private set; } = new List<ProcessRecord>(){PConsts.NullProcessRecord};
        public Dictionary<ProcessRecord,int> ProcessIndexDict { get; private set; }
