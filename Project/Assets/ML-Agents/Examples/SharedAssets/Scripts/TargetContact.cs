...
{
    /// <summary>
    /// This class contains logic for locomotion agents with joints which might make contact with a currentTarget.
    ...
    public class TargetContact : MonoBehaviour
    {
        ...
        const string k_Target = "currentTarget"; // Tag on currentTarget object.

        /// <summary>
        /// Check for collision with a currentTarget.
        /// </summary>
